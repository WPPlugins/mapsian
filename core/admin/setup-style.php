...
function register_mapsian_menu_page(){
    ...
    add_submenu_page('edit.php?post_type=maps', 'mapsian', __('Setting', 'mapsian'), 'administrator', 'm_setting', 'm_setting');
    add_submenu_page('edit.php?post_type=maps', 'mapsian', __('Document', 'mapsian'), 'administrator', 'm_about', 'm_about');
