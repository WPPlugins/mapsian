...
jQuery("body").not(".dropdown-menu").click(function(){
  ...
  jQuery("[name=select_display_list]").change(function(){

    var this_value = jQuery(this).val();

        switch(this_value){
          case "0" :
            jQuery(".maps_metabox_list_layout").addClass("deactive");
            jQuery(".maps_metabox_column_count").addClass("deactive");
          break;

          case "1" :
            jQuery(".maps_metabox_list_layout").removeClass("deactive");
            jQuery(".maps_metabox_column_count").removeClass("deactive");
          break;
        }
